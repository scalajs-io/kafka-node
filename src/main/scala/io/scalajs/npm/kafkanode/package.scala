...
package object kafkanode {
  ...
  implicit class ClientExtensions(val client: Client) extends AnyVal {
    ...
    /**
      ...
      */
    @inline
    def closeAsync(): Promise[js.Any] = futureCallbackE1[js.Error, js.Any](client.close)
  ...
  implicit class ConsumerExtensions(val consumer: Consumer) extends AnyVal {
    ...
    /**
      ...
      */
    @inline
    def addTopicsAsync(topics: String): Promise[js.Any] = futureCallbackE1[js.Error, js.Any](consumer.addTopics(topics, _))

    /**
      * @see [[Consumer.close()]]
      */
    @inline
    def closeAsync: Promise[js.Any] = futureCallbackE1[js.Error, js.Any](consumer.close)

    /**
      * @see [[Consumer.commit()]]
      */
    @inline
    def commitAsync[T <: js.Any]: Promise[T] = futureCallbackE1[js.Error, T](consumer.commit)
  ...
  implicit class HighLevelConsumerExtensions(val consumer: HighLevelConsumer) extends AnyVal {
    ...
    futureCallbackE1[js.Error, js.Any](consumer.addTopics(topics, _))
    ...
    futureCallbackE1[js.Error, js.Any](consumer.close(force, _))
  ...
  implicit class HighLevelProducerExtensions(val producer: HighLevelProducer) extends AnyVal {
    ...
    /**
      ...
      */
    @inline
    def sendAsync(payloads: js.Array[Payload]): Promise[js.Any] = futureCallbackE1[js.Error, js.Any](producer.send(payloads, _))
  ...
  implicit class OffsetExtensions(val offset: Offset) extends AnyVal {
    ...
    /**
      ...
      */
    @inline
    def fetchAsync(payloads: js.Array[Payload]): Promise[js.Any] = futureCallbackE1[js.Error, js.Any](offset.fetch(payloads, _))
